...
- Este repositorio constituye una base de Obsidian, con una serie de configuraciones poco invasivas, pero que facilitan explorar un poco todo lo que es posible en términos de customización tanto funcional como estética. 
	...
	- Paleta de colores gruv-box Dark, bastante popular y suficientemente estándar como para encontrarla en la mayoría de aplicaciones opensource. Otras opciones son Nord, Catpuccin, Everforest, Solarized, Tokyonight... (lo bueno de tener una paleta favorita estándar es que facilita mucho la cohesión entre diferentes aplicaciones)
