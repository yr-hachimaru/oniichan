...
- El README es el archivo en el que se presenta el repositorio de forma general, como si fuera un "abstract".
- Este repositorio constituye una base de Obsidian, con una serie de configuraciones poco invasivas, pero que facilitan explorar un poco todo lo que es posible en términos de customización tanto funcional como estética. 
	- *Hotkeys* para acciones importantes, como moverse entre pestañas, crear links, mover archivos entre carpetas, etc.
	- *Iconos* automáticos para archivos y directorios.
	- *Paleta* de colores gruv-box Dark, bastante popular y suficientemente estándar como para encontrarla en la mayoría de aplicaciones opensource. 
		- Otras opciones son **Nord, Catpuccin, Everforest, Solarized, Tokyonight**... (lo bueno de tener una paleta favorita estándar es que facilita mucho la cohesión entre diferentes aplicaciones)
	- *Colores* automáticos para headers, negritas, cursivas... (esto se maneja todo en el archivo .css, que lo he limpiado un poco para que sea bastante intuitivo de entender cómo funciona). Los tengo en arcoiris por defecto:
